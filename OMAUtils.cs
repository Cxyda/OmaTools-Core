...
namespace Plugins.O.M.A.Games.Core
{
    ...
    /// TODO:
    /// </summary>
    internal static class OMAUtils
    {
        private const string Prefix = ":: -- O.M.A.Tools -"; 

        internal static string GetModuleName(Type declaringType)
        {
        ...
        #if UNITY_EDITOR
        internal static T GetFloatingCameraSettings<T>() where T : ScriptableObject
        {
